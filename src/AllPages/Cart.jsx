...
export const Cart = () => {
    ...
    return <Box display={"flex"} >
        ...
        <SimpleGrid columns={{ base: 1, sm: 1, md: 2, lg: 3, xl: 3 }} p="10" spacing='20px' w="70%"  >
            {data.length !== 0 ? data?.map((e) => {
                return <>

                    <Box textAlign={"center"} boxShadow='box-shadow: 10px 10px 49px 4px rgba(0,0,0,0.75);
                                                 -webkit-box-shadow: 10px 10px 49px 4px rgba(0,0,0,0.75);
                                                 -moz-box-shadow: 10px 10px 49px 4px rgba(0,0,0,0.75)' >
